      ...
      <div
        style={{
          backgroundImage: showGrid
            ? `
							linear-gradient(0deg, transparent calc(100% - 1px), #666 calc(100% - 1px)),
							linear-gradient(90deg, transparent calc(100% - 1px), #666 calc(100% - 1px))
						`
            : undefined,
          ...
          border: showGrid ? "1px solid #666" : undefined,
